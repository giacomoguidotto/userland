...
PATH="$work/verify-bin:$PATH" \
  ...
  "$release_dir/verify-endpoint.sh" \
...
"$release_dir/assemble-site.sh" "$work/cache" v1.0.0 "$work/exact-site"
...
"$release_dir/assemble-site.sh" "$work/cache" v1.1.0 "$work/promoted-site"
