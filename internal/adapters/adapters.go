...
var registry = []adapter{
	...
	{name: "t3-auth", label: "T3 account authentication", area: plan.AreaApps, action: "configure", attention: plan.Attended, run: t3Authentication, directApply: true, enabled: machineClosureEnabled},
